  ...
  return (
    <div>
      <label className="group relative flex items-center gap-2">
        <input
          type="checkbox"
          className="appearance-none relative inline-flex items-center justify-center w-5 h-5 rounded-md border-2 border-zinc-400 group-active:scale-75 transition ease-out-back duration-300
